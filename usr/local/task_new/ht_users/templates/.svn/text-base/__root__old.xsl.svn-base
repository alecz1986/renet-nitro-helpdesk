...
<html>
  ...
  <body onLoad='start()'>
	...
	$("#creepingline").css("width" , $(document).width()-500);
      ...
      <div class='center-column'>
        <noindex>
         <script type='text/javascript'><xsl:comment><![CDATA[
          ...
          <a href='http://abz.peshca.ru/www/delivery/ck.php?n=a95bba65&amp;cb=7' target='_blank'><img src='http://abz.peshca.ru/www/delivery/avw.php?zoneid=4&amp;cb=8&amp;n=a95bba65&amp;ct0=' border='0' alt='интернет магазин Саратов' /></a>
          </noscript>
        </noindex>
        <noindex>
      ...
      <div class='left-column' css:padding-top="5px">
        <form class='search' action="/searchstring" method="get">
          <xsl:element name="input">
            ...
            <!--            <xsl:attribute name="css:position">absolute</xsl:attribute>
            <xsl:attribute name="css:left">300px</xsl:attribute>
            <xsl:attribute name="css:top">-30px</xsl:attribute>
            <xsl:attribute name="css:width">400px</xsl:attribute>-->
          </xsl:element>
          <xsl:element name="input">
            ...
            <!--<xsl:attribute name="css:position">absolute</xsl:attribute>
            <xsl:attribute name="css:left">710px</xsl:attribute>
            <xsl:attribute name="css:top">-31px</xsl:attribute>-->
          </xsl:element>
        </form>
