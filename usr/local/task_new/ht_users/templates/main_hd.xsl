    ...
    <table width="90%" class='task' cellpadding="0" cellspacing="0">
      ...
      <xsl:for-each select="/R/data/perf/th">
        <tr>
          <td>
            <xsl:element name="a">
              <xsl:attribute name="href">/hd/glob?id=<xsl:value-of select="@id_global"/></xsl:attribute>
          ...
          <td>
            <xsl:element name="a">
              <xsl:attribute name="href">/hd/thread?id=<xsl:value-of select="@id"/></xsl:attribute>
